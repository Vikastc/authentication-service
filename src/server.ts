...
// 5mb limit for document and also handle the parser errors
...
const allowedOrigins = [
    ...
    'https://api.demo.dhiway.com',
    'https://optit-hashmark-studio.dhiway.com',
    'https://optit-designer.dhiway.com',
    'https://new-feature-studio.dhiway.com',
];
